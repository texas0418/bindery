    ...
    layers: [
      {
        ...
        blocks: [
          ...
          { kind: 'label', text: 'AUDIT: balance verified ✓ · cash out exceeds itemized receipts: 4.50' },
        ],
      },
    ],
        ...
        blocks: [
          { kind: 'label', text: 'RAKING LIGHT — surface relief detected. Erased pencil survives as impression.' },
          {
            ...
            rows: [
              ...
              ['third', 'V. & E., Trinity, J-ne 19-4'],
            ],
          },
          {
            kind: 'label',
            text: 'RELIEF DETAIL — the decade digit is crushed, but its skeleton survives in the impression: one flat top stroke meeting one straight diagonal. No loop, no curve, no second upright at any depth.',
          },
        ],
      },
    ],
    ...
    layers: [
      {
        ...
        blocks: [
          ...
          {
            kind: 'margin',
            text: 'the magpie keeps what shines — never spend that. the little birds buy the door; the garden names the street. Remainders, six-and-twenty, A to Z.',
          },
        ],
      },
    ],
