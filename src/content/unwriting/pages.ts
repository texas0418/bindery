        ...
        blocks: [
          { kind: 'heading', text: 'PRESSED FLOWERS — TEN, ARRANGED IN A ROW ON BLACK PAPER' },
          {
            ...
            rows: [
              ...
              ['9', 'larkspur', 'UPSIDE DOWN'],
              ['10', 'daisy', 'upright'],
            ],
          },
          { kind: 'margin', text: 'mother’s stitching, back cover' },
          { kind: 'label', text: 'INSIDE BACK COVER — PASTED NEEDLEPOINT SAMPLER (browsable):' },
          {
            kind: 'table',
            rows: [
              ['STITCHED BLOOM', 'STITCHED WORD'],
              ['violet', 'remember'],
              ['yarrow', 'the'],
              ['flax', 'glass'],
              ['ivy', 'house'],
          ...
          { kind: 'margin', text: 'a bloom reversed speaks its opposite' },
        ],
      },
    ],
    answer: { format: 'one word, 10 letters', hash: '0c21dca2dac68648' },
    restored:
      'Remember the glass house where we were lost — ever. The flowers come from the garden where she and her daughter were happiest; the garden no longer exists, and being lost there was the point of it.',
  },
  {
    id: 6,
    layers: [
    ...
    layers: [
      {
        ...
        blocks: [
          ...
          { kind: 'label', text: 'TAPED BELOW — HAND-DRAWN DIAL ARC, letters inked at frequencies:' },
          {
            kind: 'table',
            rows: [
              ['kHz', 'LETTER'],
